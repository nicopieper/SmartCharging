...
for k=UserNum
    ...
    for l=2:ControlPeriods
        MinEnergyChargableDeadlockTS(l,1,VarCounter)=min(double(Users{k}.BatterySize)-SoC(l)-sum(MinEnergyChargableDeadlockTS(1:l-1,1,VarCounter)), Availability(l,1,VarCounter)*MaxPower(1,1,VarCounter)/4);
    end
