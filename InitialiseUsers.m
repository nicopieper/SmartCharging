...
for n=2:NumUsers+1
    ...
    Velocities(Velocities>=14 & Velocities<=33)=(Velocities(Velocities>=14 & Velocities<=33)-14)/(33-14)+1; % in between the consumption value is interpolated
    Velocities(Velocities>33)=2; % all above 33 m/s the highway consumption value
